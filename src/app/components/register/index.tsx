              ...
              <div className="bg-[#B8AADE] rounded-2xl opacity-44 flex w-full h-full">
                <div className="w-1/2 pl-[55px] h-full rounded-s-2xl">
                  <div className=" pt-[45px]">
                    <h1 className="font-bold text-[#17153B] text-2xl">
                      Register
                    </h1>
                  </div>
                  ...
                  <div>
                      <button onClick={() => signIn("google")} className="px-4 py-2 w-[300px] items-center justify-center border flex gap-2 border-slate-200 dark:border-slate-700 rounded-lg text-slate-700 dark:text-slate-200 hover:border-slate-400 dark:hover:border-slate-500 hover:text-slate-900 dark:hover:text-slate-300 hover:shadow transition duration-150">
                        <img
                          className="w-6 h-6"
